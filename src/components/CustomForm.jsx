...
const CustomForm = ({thing, handleInput, handleSumbit}) => {
    return (<>
        <h1 className="text-3xl sm:text-6xl font-bold">What is your "One Thing"?</h1>
        <form 
        ...
        >
            ...
            />
            <button
                className="bg-inherit rounded-md font-sans text-slate-800 py-2 pr-6 focus:outline-none focus:text-teal-600 hover:text-teal-600 pointer-events-none"
            >
